...
$datas = mysqli_query($koneksi, "SELECT * FROM penjualan LIMIT $halaman_awal, $batas") or die(mysqli_error($koneksi));
$no = $halaman_awal + 1;
      ...
      <div class="container-fluid">
        ...
        <table class="table text-center" border="1">
            <thead>
                ...
                <th scope="col">Obat Yang Di Beli</th>
                <th scope="col">Banyak Obat Yang Di Beli</th>
