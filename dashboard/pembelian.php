...
$datas = mysqli_query($koneksi, "SELECT * FROM pembelian LIMIT $halaman_awal, $batas") or die(mysqli_error($koneksi));
$no = $halaman_awal + 1;
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Sistem Informasi Apotek | Pembelian</h1>
          </div><!-- /.col -->
        ...
        <table class="table text-center" border="1">
            ...
            <tbody>
                ...
                <tr class="bg-dark">
                    ...
                    <td><?php echo htmlentities(ucwords($data['pemasok'])); ?></td>
                    <td><?php echo htmlentities(ucwords($data['t_transaksi'])); ?></td>
                    <td><?php echo htmlentities(ucwords($data['obat'])); ?></td>
                    <td><?php echo htmlentities(ucwords($data['harga'])); ?></td>
                    <td><?php echo htmlentities(ucwords($data['banyak_stock'])); ?></td>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body text-left bg-dark">
                                  ...
                                  <p>Pemasok : <?php echo htmlentities(ucwords($data['pemasok'])); ?></p>
                                  <p>Tanggal Transaksi : <?php echo htmlentities(ucwords($data['t_transaksi'])); ?></p>
                                  <p>Obat : <?php echo htmlentities(ucwords($data['obat'])); ?></p>
                                  <p>Harga Satuan : <?php echo htmlentities(ucwords($data['harga'])); ?></p>
                                  <p>Banyak Stock : <?php echo htmlentities(ucwords($data['banyak_stock'])); ?></p>
                                  <p>Total : <?php echo htmlentities(ucwords($data['total'])); ?></p>
                                </div>
                                <div class="modal-footer bg-dark">
                                  <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Kembali</button>
                                  <button type="submit" class="btn btn-danger" name="hapus_pembelian">Hapus</button>
                                </div>
                              </div>
                            </div>
                          </div>
